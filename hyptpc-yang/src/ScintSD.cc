...
////////////////////////////////////////////////
void ScintSD::Initialize(G4HCofThisEvent* HCTE)
  ////////////////////////////////////////////////
{
  // create hit collection(s)
  hitsCollection = new G4THitsCollection<ScintHit>( SensitiveDetectorName,
      collectionName[0]);
  ...
  ///////////////////////////////////////////////////////////
{
  ...
  */
  ...
  ScintHit* ahit= new ScintHit(pos, mom, tof, tid, pid, iDet,mass,qq,parentID, VertexPosition, VertexMomentum, VertexEnergy,tlength);
...
////////////////////////////////////////////////////
void ScintSD::EndOfEvent(G4HCofThisEvent* HCTE)
  ////////////////////////////////////////////////////
{
}
