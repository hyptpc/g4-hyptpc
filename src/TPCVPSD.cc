...
TPCVPSD::TPCVPSD( const G4String& name )
...
//_____________________________________________________________________________
TPCVPSD::~TPCVPSD( void )
{
}

//_____________________________________________________________________________
void
TPCVPSD::Initialize( G4HCofThisEvent* HCTE )
{
  m_hits_collection = new G4THitsCollection<TPCVPHit>( SensitiveDetectorName,
							 collectionName[0] );
...
//_____________________________________________________________________________
G4bool
TPCVPSD::ProcessHits( G4Step* aStep, G4TouchableHistory* /* ROhist */ )
{
  ...
  m_hits_collection->insert( new TPCVPHit( SensitiveDetectorName, aStep ) );
...
//_____________________________________________________________________________
void
TPCVPSD::EndOfEvent( G4HCofThisEvent* /* HCTE */ )
{
}

//_____________________________________________________________________________
void
TPCVPSD::DrawAll( void )
{
}

//_____________________________________________________________________________
void
TPCVPSD::PrintAll( void )
{
