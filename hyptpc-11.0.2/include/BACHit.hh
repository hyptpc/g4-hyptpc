...
public:
  BACHit();
  //  BACHit(G4ThreeVector& axyz, G4double t);
  BACHit(G4ThreeVector& axyz, G4ThreeVector& apxyz, G4double t);
  BACHit(G4ThreeVector& axyz, G4ThreeVector& apxyz, G4double t,
...
{
  return BACHitAllocator.MallocSingle();
}
...
{
  BACHitAllocator.FreeSingle(static_cast<BACHit*>(aHit));
}
