...
BH2SD::BH2SD(const G4String& name)
...
//_____________________________________________________________________________
G4bool
BH2SD::ProcessHits(G4Step* aStep, G4TouchableHistory* /* ROhist */)
{
  ...
  m_hits_collection->insert(new BH2Hit(SensitiveDetectorName, aStep));
...
//_____________________________________________________________________________
void
BH2SD::EndOfEvent(G4HCofThisEvent* /* HCTE */)
{
}
