...
{
  ntrk=0;
  hitsCollection = new G4THitsCollection<TPCHit>(SensitiveDetectorName,
                                                 collectionName[0]);
...
TPCSD::ProcessHits(G4Step* aStep, G4TouchableHistory* /* ROhist */)
{
  ...
  */
  ...
  TPCHit* ahit= new TPCHit(pos, mom, tof, tid, pid, iLay, iRow, beta, edep,parentID,tlength, mass, charge, VertexPosition, VertexMomentum, VertexEnergy,slength, parentID_pid);
