...
DetectorConstruction::Construct()
{
  ConstructElements();
  ConstructMaterials();
  auto world_solid = new G4Box("WorldSolid", 10.*CLHEP::m/2, 6.*CLHEP::m/2, 16.*CLHEP::m/2);
...
DetectorConstruction::ConstructElements()
{
  ...
  m_element_map[name] = new G4Element(name, symbol="Na", Z=11.,
                                      A=22.989768 *CLHEP::g/CLHEP::mole);
  name = "Silicon";
  ...
  m_element_map[name] = new G4Element(name, symbol="P", Z=15.,
                                      A=30.973762 *CLHEP::g/CLHEP::mole);
  name = "Sulfur";
  m_element_map[name] = new G4Element(name, symbol="S", Z=16.,
                                      A=32.066 *CLHEP::g/CLHEP::mole);
  name = "Argon";
  ...
  m_element_map[name] = new G4Element(name, symbol="Mn", Z=25.,
                                      A=54.93805 *CLHEP::g/CLHEP::mole);
  name = "Iron";
  m_element_map[name] = new G4Element(name, symbol="Fe", Z=26.,
                                      A=55.847 *CLHEP::g/CLHEP::mole);
  name = "Nickel";
  ...
  m_element_map[name] = new G4Element(name, symbol="I",  Z=53.,
                                      A=126.90447 *CLHEP::g/CLHEP::mole);
  name = "Cesium";
  m_element_map[name] = new G4Element(name, symbol="Cs", Z=55.,
                                      A=132.90543 *CLHEP::g/CLHEP::mole);
}
...
DetectorConstruction::ConstructMaterials()
{
  ...
  */
  ...
  const G4double room_temp = CLHEP::STP_Temperature + 20.*CLHEP::kelvin;
  // Vacuum
  name = "Vacuum";
  m_material_map[name] = new G4Material(name, density=CLHEP::universe_mean_density,
                                        nel=2);
  m_material_map[name]->AddElement(m_element_map["Nitrogen"], 0.7);
  m_material_map[name]->AddElement(m_element_map["Oxygen"], 0.3);
  // Air
  name = "Air";
  m_material_map[name] = new G4Material(name, density=1.2929e-03*CLHEP::g/CLHEP::cm3,
  ...
  // Water
  name = "Water";
  m_material_map[name] = new G4Material(name, density=1.*CLHEP::g/CLHEP::cm3, nel=2);
  m_material_map[name]->AddElement(m_element_map["Hydrogen"], 2);
  m_material_map[name]->AddElement(m_element_map["Oxygen"], 1);
  // Aluminum
  name = "Aluminum";
  m_material_map[name] = new G4Material(name, Z=13., A=26.9815*CLHEP::g/CLHEP::mole,
                                        density=2.699*CLHEP::g/CLHEP::cm3);
  // Iron
  name = "Iron";
  m_material_map[name] = new G4Material(name, Z=26., A=55.85*CLHEP::g/CLHEP::mole,
                                        density=7.87*CLHEP::g/CLHEP::cm3);
  // Copper
  name = "Copper";
  m_material_map[name] = new G4Material(name, Z=29., A=63.546*CLHEP::g/CLHEP::mole,
                                        density=8.96*CLHEP::g/CLHEP::cm3);
  // Carbon
  name = "Carbon";
  m_material_map[name] = new G4Material(name, Z=6., A = 12.0107*CLHEP::g/CLHEP::mole,
                                        density=2.265*CLHEP::g/CLHEP::cm3);
  // Diamond
  name = "Diamond";
  m_material_map[name] = new G4Material(name, Z=6., A = 12.0107*CLHEP::g/CLHEP::mole,
                                        density=3.34*CLHEP::g/CLHEP::cm3);
  // LH2
  name = "LH2";
  m_material_map[name] = new G4Material(name, Z=1., A=1.008*CLHEP::g/CLHEP::mole,
                                        density=70.99*CLHEP::mg/CLHEP::cm3);
  // LD2
  name ="LD2";
  m_material_map[name] = new G4Material(name, Z=1., A=2.01410*CLHEP::g/CLHEP::mole,
                                        density=166.0*CLHEP::mg/CLHEP::cm3);
  // Ar gas
  name = "Argon";
  G4double densityAr = 1.782e-03 * CLHEP::g/CLHEP::cm3 * CLHEP::STP_Temperature / room_temp;
  density = densityAr;
  m_material_map[name] = new G4Material(name, Z=18., A=39.948*CLHEP::g/CLHEP::mole,
                                        density, kStateGas, room_temp);
  // Ethane (C2H6)
  name = "Ethane";
  G4double densityEthane = 1.356e-3 *CLHEP::g/CLHEP::cm3 * CLHEP::STP_Temperature / room_temp;
  ...
  // Methane (CH4)
  name = "Methane";
  G4double densityMethane = 0.717e-3 *CLHEP::g/CLHEP::cm3 * CLHEP::STP_Temperature / room_temp;
  ...
  // G10 epoxy glass
  name = "G10";
  m_material_map[name] = new G4Material(name, density=1.700*CLHEP::g/CLHEP::cm3,
                                        ncomponents=4);
  ...
  name = "Scintillator";
  m_material_map[name] = new G4Material(name, density=1.032*CLHEP::g/CLHEP::cm3, nel=2);
  ...
  // CH2 Polyethelene
  name = "CH2";
  m_material_map[name] = new G4Material(name, density=0.95*CLHEP::g/CLHEP::cm3, nel=2);
  m_material_map[name]->AddElement(m_element_map["Carbon"], natoms=1);
  m_material_map[name]->AddElement(m_element_map["Hydrogen"], natoms=2);
  // Silica Aerogel for LAC
  name = "SilicaAerogelLAC";
  m_material_map[name] = new G4Material(name, density=0.18 *CLHEP::g/CLHEP::cm3, nel=2);
  m_material_map[name]->AddElement(m_element_map["Silicon"], natoms=1);
  m_material_map[name]->AddElement(m_element_map["Oxygen"],  natoms=2);
  // Quartz (SiO2, crystalline)
  name = "Quartz";
  m_material_map[name] = new G4Material(name, density=2.64 *CLHEP::g/CLHEP::cm3, nel=2);
  m_material_map[name]->AddElement(m_element_map["Silicon"], natoms=1);
  m_material_map[name]->AddElement(m_element_map["Oxygen"],  natoms=2);
  // Acrylic for WC
  name = "Acrylic";
  m_material_map[name] = new G4Material(name, density=1.18 *CLHEP::g/CLHEP::cm3, nel=3);
...
{
  //const G4ThreeVector size(5.0*CLHEP::m/2, 5.0*CLHEP::m/2, 6.0*CLHEP::m/2);
  const G4ThreeVector size(4.8*CLHEP::m/2, 4.8*CLHEP::m/2, 6.3*CLHEP::m/2);
  //const G4ThreeVector pos(0., 0., -143.-1200.-170.*CLHEP::mm+size.z());
  const G4ThreeVector pos(0., 0., -1270.-119.*CLHEP::mm+size.z());
  auto tent_out_solid = new G4Box("AreaTentOutSolid",
                                  size.x(), size.y(), size.z());
  auto tent_in_solid = new G4Box("AreaTentInSolid", size.x()-1.*CLHEP::mm,
                                 size.y()-1.*CLHEP::mm, size.z()-1.*CLHEP::mm);
...
DetectorConstruction::ConstructBC3()
{
  ...
  const auto& frame_size = gSize.GetSize("Bc3Frame") * 0.5 * CLHEP::mm;
  const auto& drift_size = gSize.GetSize("Bc3Drift") * 0.5 * CLHEP::mm;
  ...
  for(G4int i=0; i<NumOfLayersBcOut/2; ++i){
    G4ThreeVector pos;
    switch (i) {
    case 0: pos.setZ(-22.*CLHEP::mm); break;
    case 1: pos.setZ(-18.*CLHEP::mm); break;
    case 2: pos.setZ( -2.*CLHEP::mm); break;
    case 3: pos.setZ(  2.*CLHEP::mm); break;
    case 4: pos.setZ( 18.*CLHEP::mm); break;
    case 5: pos.setZ( 22.*CLHEP::mm); break;
    }
...
DetectorConstruction::ConstructBC4()
{
  ...
  const auto& frame_size = gSize.GetSize("Bc4Frame") * 0.5 * CLHEP::mm;
  const auto& drift_size = gSize.GetSize("Bc4Drift") * 0.5 * CLHEP::mm;
...
{
  const auto& ra2 = gGeom.GetRotAngle2("BH2") * CLHEP::deg;
  const auto& half_size = gSize.GetSize("Bh2Seg") * 0.5 * CLHEP::mm;
  const G4double pitch = gGeom.GetWirePitch("BH2") *CLHEP::mm;
  auto bh2SD = new BH2SD("/BH2");
  G4SDManager::GetSDMpointer()->AddNewDetector(bh2SD);
  // Mother
  auto mother_solid = new G4Box("Bh2MotherSolid",
                                half_size.x()*NumOfSegBH2 + 50.*CLHEP::mm,
                                half_size.y() + 50.*CLHEP::mm,
                                half_size.z()*2 + 50.*CLHEP::mm);
  ...
  for(G4int i=0; i<NumOfSegBH2; ++i){
    if(i==0){ //left edge
      pos = G4ThreeVector((-NumOfSegBH2/2 + i + 0.5)*pitch - 1.5*CLHEP::mm, 0.*CLHEP::mm, 0.*CLHEP::mm);
      ...
      pos = G4ThreeVector((-NumOfSegBH2/2 + i + 0.5)*pitch, 0.*CLHEP::mm, 0.*CLHEP::mm);
...
DetectorConstruction::ConstructFTOF()
{
  ...
  const auto& half_size = gSize.GetSize("FtofSeg") * 0.5 * CLHEP::mm;
  const G4double pitch = gGeom.GetWirePitch("TOF") * CLHEP::mm;
  auto ftofSD = new FTOFSD("/FTOF");
  G4SDManager::GetSDMpointer()->AddNewDetector(ftofSD);
  // Mother
  auto mother_solid = new G4Box("FtofMotherSolid",
                                half_size.x()*NumOfSegTOF + 50.*CLHEP::mm,
                                half_size.y() + 50.*CLHEP::mm,
                                half_size.z()*2 + 50.*CLHEP::mm);
  auto mother_lv = new G4LogicalVolume(mother_solid,
                                       m_material_map["Air"],
...
DetectorConstruction::ConstructHTOF()
{
  ...
  const auto& half_size = gSize.GetSize("HtofSeg") * 0.5 * CLHEP::mm;
  ...
  rotM_upper_lg->rotateX(90.0 *CLHEP::deg);
  rotM_upper_lg->rotateZ(- 180.0 *CLHEP::deg);
  G4ThreeVector trans_upper_lg(0.*CLHEP::mm , half_size.y() + lg_size.y(),  0.*CLHEP::mm);
  ...
  rotM_lower_lg->rotateX(- 90.0 *CLHEP::deg);
  rotM_lower_lg->rotateZ(- 180.0 *CLHEP::deg);
  G4ThreeVector trans_lower_lg(0.*CLHEP::mm , -half_size.y() - lg_size.y() , 0.*CLHEP::mm);
  ...
  G4double HTOF_window=110.*CLHEP::mm;
  auto window_dummy = new G4Box("window_dummy", half_size.x(), half_size.y()/2. - HTOF_window/4., half_size.z());

  //Upper slats(Beam-through)
  G4ThreeVector trans_upper_window(0.*CLHEP::mm , half_size.y()/2. - HTOF_window/4. + lg_size.y(),  0.*CLHEP::mm);
  ...
  G4ThreeVector trans_lower_window(0.*CLHEP::mm , -half_size.y()/2. + HTOF_window/4. - lg_size.y(),  0.*CLHEP::mm);
  ...
  for(G4int i=0; i<NumOfPlaneHTOF; ++i){
    for(G4int j=0; j<NumOfSegHTOFOnePlane; ++j){
      ...
      rotMOutP->rotateY(- i * 360./NumOfPlaneHTOF*CLHEP::deg);
      seg_pos.rotateY(i * 360./NumOfPlaneHTOF*CLHEP::deg);
      seg_pos += htof_pos;
      G4int copy_no = seg+2;

      G4ThreeVector window_pos(0.*CLHEP::mm, half_size.y()/2. + HTOF_window/4., 0.*CLHEP::mm);
      //common slats
  ...
  auto RingHoleOut = new G4Box("RingHoleOut", 127.5*CLHEP::mm, 6.0*CLHEP::mm, 5.*CLHEP::mm);
  auto RingHoleIn = new G4Box("RingHoleIn", 10.*CLHEP::mm, 6.*CLHEP::mm, 5.*CLHEP::mm);
  auto RingHole = new G4SubtractionSolid("RingHole" , RingHoleOut, RingHoleIn);

  // Top Ring
  const G4double RingIn_zPlane[2] = { -5.*CLHEP::mm, 5.*CLHEP::mm };
  const G4double RingIn_rInner[2] = { 0.*CLHEP::mm, 0.*CLHEP::mm };
  const G4double RingIn_rOuter[2] =  { 334.13*CLHEP::mm, 334.13*CLHEP::mm } ;
  auto TopRingOutSolid = new G4Tubs("TopRingOutSolid", 0.*CLHEP::mm, 391.97*CLHEP::mm,
                                    5.*CLHEP::mm, 0.*CLHEP::deg, 360.*CLHEP::deg);
  auto TopRingInSolid = new G4Polyhedra("TopRingInSolid", 22.5*CLHEP::deg, (360. + 22.5)*CLHEP::deg,
                                        8, 2,
  ...
  for(G4int i=0; i<8; i++){
    ...
    rotMHole->rotateZ(i * 45.0 * CLHEP::deg);
    G4ThreeVector trans_hole(0*CLHEP::mm, 348.13*CLHEP::mm, 0.*CLHEP::mm);
    trans_hole.rotateZ(- i * 45.0 * CLHEP::deg);
  ...
  // Bottom Ring
  const G4double RingOut_zPlane[2] = { -5.*CLHEP::mm, 5.*CLHEP::mm };
  const G4double RingOut_rInner[2] = { 334.13*CLHEP::mm, 334.13*CLHEP::mm };
  const G4double RingOut_rOuter[2] = { 362.13*CLHEP::mm, 362.13*CLHEP::mm };
  auto BotRingOutSolid = new G4Polyhedra("BotRingOutSolid", 22.5*CLHEP::deg, (360. + 22.5)*CLHEP::deg,
                                         8, 2,
  ...
  // Bracket
  auto BraInSolid = new G4Box("BraInSolid", 137.5*CLHEP::mm, 75.*CLHEP::mm, 2.5*CLHEP::mm);
  auto BraInHole = new G4Box("BraInHole", 127.5*CLHEP::mm, 30.*CLHEP::mm, 2.5*CLHEP::mm);
  G4ThreeVector brain_trans_hole(0.*CLHEP::mm, 25.*CLHEP::mm, 0.*CLHEP::mm);
  auto BraInSubSolid = new G4SubtractionSolid("BraInSubSolid", BraInSolid, BraInHole,
                                              0, brain_trans_hole);

  auto BraOutSolid = new G4Box("BraOutSolid", 137.5*CLHEP::mm, 2.5*CLHEP::mm, 16.5*CLHEP::mm);
  G4ThreeVector braout_trans_hole(0.*CLHEP::mm, 0.*CLHEP::mm, 3.5*CLHEP::mm);
  auto BraOutSubSolid = new G4SubtractionSolid("BraOutSubSolid", BraOutSolid, RingHole,
                                               0, braout_trans_hole);

  G4ThreeVector trans_braket(0.*CLHEP::mm, 72.5*CLHEP::mm, 14.*CLHEP::mm);
  ...
  const G4double PreFrameIn_zPlane[2] = { -37.*CLHEP::mm, 37.*CLHEP::mm };
  const G4double PreFrameIn_rInner[2] = { 334.13*CLHEP::mm, 334.13*CLHEP::mm };
  const G4double PreFrameIn_rOuter[2] = { 339.13*CLHEP::mm, 339.13*CLHEP::mm } ;
  auto PreFrameInSolid = new G4Polyhedra("PreFrameInSolid", 22.5*CLHEP::deg, (360. + 22.5)*CLHEP::deg,
                                         8, 2,
                                         PreFrameIn_zPlane,  PreFrameIn_rInner,  PreFrameIn_rOuter);

  const G4double PreFrameOut_zPlane[2] = { -32.5*CLHEP::mm, 32.5*CLHEP::mm };
  const G4double PreFrameOut_rInner[2] = { 354.13*CLHEP::mm, 354.13*CLHEP::mm };
  const G4double PreFrameOut_rOuter[2] = { 362.13*CLHEP::mm, 362.13*CLHEP::mm } ;
  auto PreFrameOutSolid = new G4Polyhedra("PreFrameOutSolid", 22.5*CLHEP::deg, (360. + 22.5)*CLHEP::deg,
                                          8, 2,
                                          PreFrameOut_zPlane,  PreFrameOut_rInner,  PreFrameOut_rOuter);
  auto PreFrameHole = new G4Box("PreFrameHole", 3.5*CLHEP::mm, 4.0*CLHEP::mm, 32.5*CLHEP::mm);
  ...
  G4ThreeVector trans_preframe(0.*CLHEP::mm, 0.*CLHEP::mm, -9.0*CLHEP::mm);
  ...
  // Bar
  auto BarMainSolid = new G4Box("BarMainSolid", 45.*CLHEP::mm, 618.25*CLHEP::mm, 5.*CLHEP::mm);
  auto BarSideSolid = new G4Box("BarSideSolid", 5.*CLHEP::mm, 618.25*CLHEP::mm, 5.*CLHEP::mm);
  G4ThreeVector trans_bar_side(-40.*CLHEP::mm, 0.*CLHEP::mm, -10.*CLHEP::mm);
  auto BarUniSolid = new G4UnionSolid("BarUniSolid", BarMainSolid, BarSideSolid,
                                      0, trans_bar_side);

  auto BarBotSolid = new G4Box("BarSideSolid", 45.*CLHEP::mm, 5.*CLHEP::mm, 5.*CLHEP::mm);
  G4ThreeVector trans_bar_bot(0.*CLHEP::mm, -613.25*CLHEP::mm, -10.*CLHEP::mm);
  ...
  if(false){   // Htof Frame Placement
    ...
    rotMOutRing->rotateX(- 90. *CLHEP::deg);

    // Top Ring
    G4ThreeVector TopRing_pos(0.*CLHEP::mm, 586.72*CLHEP::mm, 0.*CLHEP::mm);
    TopRing_pos += htof_pos;
    new G4PVPlacement(rotMOutRing, TopRing_pos, TopRing_lv, "TopRingPV", m_world_lv, false, 0);

    // Bottom Ring
    G4ThreeVector BotRing_pos(0.*CLHEP::mm, -586.72*CLHEP::mm, 0.*CLHEP::mm);
    ...
    for(G4int i=0; i<2; ++i){
      ...
      rotMOutP_PreFrame->rotateX((1 - 2 * i) * 90.*CLHEP::deg);
      rotMOutP_PreFrame->rotateZ(i * 180.*CLHEP::deg);

      G4ThreeVector PreFrame_pos(0.*CLHEP::mm, 453.22*CLHEP::mm, 0.*CLHEP::mm);
      PreFrame_pos.rotateZ(- i * 180.*CLHEP::deg);
    ...
    for(G4int i=0; i<NumOfPlaneHTOF; ++i){
      ...
      rotMOutP_bar->rotateY(- i * 45.*CLHEP::deg);
      G4ThreeVector Bar_pos(0.*CLHEP::mm, - 36.53*CLHEP::mm, - 372.13*CLHEP::mm);
      Bar_pos.rotateY(i * 45.*CLHEP::deg);
      Bar_pos += htof_pos;
	...
	rotMOutP_bra->rotateY( - (1 - 2 * j) * i * 45.*CLHEP::deg);
	rotMOutP_bra->rotateZ( - j * 180.*CLHEP::deg);
	G4ThreeVector Bra_pos(0.*CLHEP::mm, 506.72*CLHEP::mm, - 364.63*CLHEP::mm);
	Bra_pos.rotateY(i * 45.*CLHEP::deg);
	Bra_pos.rotateZ(j * 180.*CLHEP::deg);
	Bra_pos += htof_pos;
	G4int Bra_seg = 2 * i + j;
...
DetectorConstruction::ConstructHypTPC()
{
  ...
  const auto target_size = gSize.GetSize("Target") * 0.5 * CLHEP::mm;
  const auto holder_size = gSize.GetSize("TargetHolder") * CLHEP::mm;
  ...
  case 42: {
    ...
    holder_solid = new G4Tubs("TargetHolderSolid", holder_size.x() /* Rin */,
                              holder_size.y() /* Rout */,
                              holder_size.z()/2 /* DZ */, 0., 360.*CLHEP::deg);
    holder_pos = target_pos;
  }
    break;
  case 45: case 27: {
    //  G4Box* TargetSolid = new G4Box("target", 1.5*CLHEP::cm,0.25*CLHEP::cm,0.5*CLHEP::cm);
    ...
    target_solid = new G4Tubs("TargetSolid", 0.*CLHEP::mm,
                              Target_r*CLHEP::mm,Target_z*CLHEP::mm, 0., 360*CLHEP::deg);
    //  G4Box* TargetSolid = new G4Box("target", 1.*CLHEP::cm,0.25*CLHEP::cm,1.*CLHEP::cm);
    holder_solid = new G4Tubs("TargetHolderSolid", (Target_r + 15.)*CLHEP::mm,
                              (Target_r + 15.2)*CLHEP::mm, 200.*CLHEP::mm, 0., 360*CLHEP::deg);
    // holder_pos.set(0*CLHEP::mm, 100.*CLHEP::mm, target_pos.z());
  }
    break;
  default:
    return;
  ...
  // HypTPC
  {
    const G4double Rin  = gSize.Get("TpcRin")*CLHEP::mm/2;
    const G4double Rout = gSize.Get("TpcRout")*CLHEP::mm/2;
    const G4double Dz   = gSize.Get("TpcDz")*CLHEP::mm;
    ...
    auto tpc_out_solid = new G4Polyhedra("TpcOutSolid",
                                         22.5*CLHEP::deg, (360. + 22.5)*CLHEP::deg,
                                         NumOfSide, NumOfZPlane,
                                         zPlane, rInner, rOuter);
    auto pos = target_pos;
    pos.rotateX(90.*CLHEP::deg);
  ...
  // Field Cage
  {
    const G4double Rin  = gSize.Get("TpcRinFieldCage")*CLHEP::mm*0.5;
    const G4double Rout = gSize.Get("TpcRoutFieldCage")*CLHEP::mm*0.5;
    const G4double Dz   = gSize.Get("TpcDzFieldCage")*CLHEP::mm;
    const G4int NumOfSide   = 8;
    const G4int NumOfZPlane = 2;
    const G4double zPlane[NumOfZPlane] = { -Dz, Dz };
    const G4double rInner[NumOfZPlane] = { Rin, Rin };
    const G4double rOuter[NumOfZPlane] = { Rout, Rout };
    auto fc_solid = new G4Polyhedra("FcSolid", 22.5*CLHEP::deg, (360. + 22.5)*CLHEP::deg,
                                    NumOfSide, NumOfZPlane,
                                    zPlane, rInner, rOuter);
  ...
  const G4double pad_center_z = gSize.Get("TpcPadCenterZ")*CLHEP::mm;
  G4double pad_in[NumOfPadTPC] = {};
  G4double pad_out[NumOfPadTPC] = {};
  G4double tpc_rad = 250;
  // out side less 100 CLHEP::mm. 10+5*x < 100 CLHEP::mm is pad_in_num
  ...
  case 3:
    ...
    for(G4int i=0; i<NumOfPadTPC; ++i){
      ...
      pad_in[i] = pad_radius;
      pad_out[i] = pad_radius + 0.1*CLHEP::mm;
      /*
  ...
  for(G4int i=0; i<NumOfPadTPCIn; ++i){
    if(pad_out[i]<below_target){
      if(m_experiment==42){
	pad_solid[i] = new G4Tubs(Form("TpcPadSolid%d", i), pad_in[i]*CLHEP::mm,
                                  pad_out[i]*CLHEP::mm, 120.*CLHEP::mm, 0.,
                                  angle[i]*CLHEP::deg);
      }else if(m_experiment==45||m_experiment==27){
	pad_solid[i] = new G4Tubs(Form("TpcPadSolid%d", i), pad_in[i]*CLHEP::mm,
                                  pad_out[i]*CLHEP::mm, 200./2.*CLHEP::mm, 0.,
                                  angle[i]*CLHEP::deg);
      }
      pad_lv[i]  = new G4LogicalVolume(pad_solid[i], m_material_map["P10"],
                                       Form("TpcPadLV%d", i));
    } else {
      pad_solid[i] = new G4Tubs("TpcPadSolid", pad_in[i]*CLHEP::mm, pad_out[i]*CLHEP::mm,
                                275.*CLHEP::mm, 0., angle[i]*CLHEP::deg);
      pad_lv[i]  = new G4LogicalVolume(pad_solid[i], m_material_map["P10"],
                                       Form("TpcPadLV%d", i));
    }
    ...
    if(pad_out[i] < below_target){
      if(m_experiment == 42){
	new G4PVPlacement(nullptr, G4ThreeVector(0., -pad_center_z, (-120.-25.)*CLHEP::mm),
                          pad_lv[i], Form("TpcPadPV%d", i), m_tpc_lv, true, i);
      } else if(m_experiment == 45 || m_experiment == 27){
	new G4PVPlacement(nullptr, G4ThreeVector(0., -pad_center_z, (-200.)*CLHEP::mm),
                          pad_lv[i], Form("TpcPadPV%d", i), m_tpc_lv, true, i);
      }
    }else{
      new G4PVPlacement(nullptr, G4ThreeVector(0., -pad_center_z, -25.*CLHEP::mm),
                        pad_lv[i], Form("TpcPadPV%d", i), m_tpc_lv, true, i);
    }
  }
  G4ThreeVector padpos(0., -pad_center_z, -25.*CLHEP::mm);
  for(G4int i=NumOfPadTPCIn; i<NumOfPadTPC; ++i){
    pad_solid[i] = new G4Tubs(Form("TpcPadSolid%d", i), pad_in[i]*CLHEP::mm,
                              pad_out[i]*CLHEP::mm, 275.*CLHEP::mm, (90.+angle[i])*CLHEP::deg,
                              (360.-2.*angle[i])*CLHEP::deg);
    pad_lv[i]  = new G4LogicalVolume(pad_solid[i], m_material_map["P10"],
				     Form("TpcPadLV%d", i));
  ...
  // Dead area
  auto dead_solid = new G4Box("DeadSolid", 5*CLHEP::mm, 250*CLHEP::mm, 0.001*CLHEP::mm);
  auto dead_lv = new G4LogicalVolume(dead_solid, m_material_map["Carbon"],
                                     "DeadLV");
  auto rotdead1 = new G4RotationMatrix;
  rotdead1->rotateZ(45.*CLHEP::deg);
  new G4PVPlacement(rotdead1, G4ThreeVector(0., 0.*CLHEP::mm, -300.1*CLHEP::mm),
                    dead_lv, "DeadPV1", m_tpc_lv, true, 0);
  auto rotdead2 = new G4RotationMatrix;
  rotdead2->rotateZ(-45.*CLHEP::deg);
  new G4PVPlacement(rotdead2, G4ThreeVector(0., 0.*CLHEP::mm, -300.1*CLHEP::mm),
  ...
  for(G4int i=0; i<NumOfPadTPCIn; ++i){
    vpad_solid[i] = new G4Tubs(Form("TpcVPadSolid%d", i), pad_in[i]*CLHEP::mm,
                               pad_out[i]*CLHEP::mm, 0.5*CLHEP::mm, 0., 360.*CLHEP::deg);
    vpad_lv[i] = new G4LogicalVolume(vpad_solid[i], m_material_map["P10"],
                                     Form("TpcVPadLV%d", i));
    vpad_lv[i]->SetVisAttributes(G4Colour::Blue());
    new G4PVPlacement(nullptr,
                      G4ThreeVector(0., -pad_center_z, -302.*CLHEP::mm),
                      vpad_lv[i], Form("TpcVPadPV%d", i), m_tpc_lv, true, 0);
  }
  for(G4int i=NumOfPadTPCIn; i<NumOfPadTPC; ++i){
    vpad_solid[i] = new G4Tubs(Form("TpcVPadSolid%d", i),  pad_in[i]*CLHEP::mm,
                               pad_out[i]*CLHEP::mm,
                               0.5*CLHEP::mm, (90.+angle[i])*CLHEP::deg,
                               (360.-2.*angle[i])*CLHEP::deg);
    vpad_lv[i] = new G4LogicalVolume(vpad_solid[i], m_material_map["P10"],
                                     Form("TpcVPadLV%d", i));
...
DetectorConstruction::ConstructK18BeamlineSpectrometer()
{
  G4cout << FUNC_NAME << G4endl;
  // D4 magnet
  const G4double D4Rho = gSize.Get("D4Rho")*CLHEP::mm;
  const G4double D4BendAngle = gSize.Get("D4BendAngle")*CLHEP::deg; // [deg]
  const auto& D4FieldSize = gSize.GetSize("D4Field")*CLHEP::mm;
  const G4double D4r1 = D4Rho - D4FieldSize.x()/2.;
  const G4double D4r2 = D4Rho + D4FieldSize.x()/2.;
  const G4double D4Width1 = 1700.*CLHEP::mm/2;
  // const auto& D4Coil1Size = gSize.GetSize("D4Coil1")*CLHEP::mm;
  // const G4double D4CoilWidth1 = 500.*CLHEP::mm/2;
  // const G4double D4CoilLength1 = 200.*CLHEP::mm/2;
  // const G4double D4CoilLength2 = 100.*CLHEP::mm/2;
  // const G4double D4Length = 4.468*CLHEP::m;
  const G4double D4B0 = 15.010222 * CLHEP::kilogauss;
  const G4double D4alpha = 23.5; // [deg]
  const G4double D4beta = 0; // [deg]
  // Q10 magnet
  const auto& Q10Size = gSize.GetSize("Q10")*CLHEP::mm;
  const G4double Q10B0 = -9.814096 * CLHEP::kilogauss;
  const G4double Q10a0 = 0.1*CLHEP::m;    // [m]
  // Q11 magnet
  const auto& Q11Size = gSize.GetSize("Q11")*CLHEP::mm;
  const G4double Q11B0 = 7.493605 * CLHEP::kilogauss;
  const G4double Q11a0 = 0.1*CLHEP::m;
  // Q12 magnet
  const auto& Q12Size = gSize.GetSize("Q12")*CLHEP::mm;
  const G4double Q12B0 = -5.87673 * CLHEP::kilogauss;
  const G4double Q12a0 = 0.1*CLHEP::m;
  // Q13 magnet
  const auto& Q13Size = gSize.GetSize("Q13")*CLHEP::mm;
  const G4double Q13B0 = 0. * CLHEP::kilogauss;
  const G4double Q13a0 = 0.1*CLHEP::m;      // [m]
  const G4double driftL0 = gSize.Get("K18L0")*CLHEP::mm; // VI-Q10
  const G4double driftL1 = gSize.Get("K18L1")*CLHEP::mm; // Q10-Q11
  const G4double driftL2 = gSize.Get("K18L2")*CLHEP::mm; // Q11-D4
  const G4double driftL3 = gSize.Get("K18L3")*CLHEP::mm; // D4-Q12
  const G4double driftL4 = gSize.Get("K18L4")*CLHEP::mm; // Q12-Q13
  const G4double driftL5 = gSize.Get("K18L5")*CLHEP::mm; // Q13-VO
  const G4double driftL6 = gSize.Get("K18L6")*CLHEP::mm; // VO-FF:1200, VO-HS
  // const G4double driftL7 = gSize.Get("K18L7")*CLHEP::mm; // HS-KURAMA
  ...
  G4cout << "   D4r1 = " << D4r1/CLHEP::m  << ", D4r2 = " << D4r2/CLHEP::m  << G4endl;
  auto D4Solid = new G4Tubs("D4Solid", D4r1, D4r2, D4FieldSize.y()/2,
                            0.*CLHEP::deg, D4BendAngle);
  ...
  D4Rot->rotateX(90.*CLHEP::deg);
  D4Rot->rotateZ(180.*CLHEP::deg + D4BendAngle);
  ...
  D4Info.bend = D4BendAngle/CLHEP::deg;
...
DetectorConstruction::ConstructKuramaMagnet()
{
  ...
  const auto field_size = gSize.GetSize("KuramaField") * 0.5 * CLHEP::mm;
  const auto coil_color = G4Colour::Red();
  // size
  const G4ThreeVector coil1_size(900.*CLHEP::mm/2, 193.*CLHEP::mm/2, 280.*CLHEP::mm/2);
  const G4ThreeVector coil2_size(193.*CLHEP::mm/2, 117.*CLHEP::mm/2, 280.*CLHEP::mm/2);
  const G4ThreeVector coil3_size(193.*CLHEP::mm/2, 137.*CLHEP::mm/2, 280.*CLHEP::mm/2);
  const G4ThreeVector coil4_size(193.*CLHEP::mm/2, 280.*CLHEP::mm/2, 740.*CLHEP::mm/2);
  const G4ThreeVector coil5_size(900.*CLHEP::mm/2, 214.*CLHEP::mm/2, 280.*CLHEP::mm/2);
  const G4ThreeVector yoke_inner_size(field_size.x() + 193.*CLHEP::mm,
                                      field_size.y(), field_size.z());
  const G4ThreeVector yoke_outer_size(1800.*CLHEP::mm/2, 2200.*CLHEP::mm/2,
                                      field_size.z());
  const G4ThreeVector yoke_ud_size(2200.*CLHEP::mm/2, 370.*CLHEP::mm/2, field_size.z());
  const G4ThreeVector yoke_lr_size(200.*CLHEP::mm/2, field_size.y(),
                                   field_size.z());
  const G4ThreeVector uguard_inner_size(600.*CLHEP::mm/2, 300.*CLHEP::mm/2, 100.*CLHEP::mm/2);
  const G4ThreeVector uguard_inner2_size(50.*CLHEP::mm/2, 50.*CLHEP::mm/2, 100.*CLHEP::mm/2);
  const G4ThreeVector uguard_outer_size(1600.*CLHEP::mm/2, 2200.*CLHEP::mm/2, 100.*CLHEP::mm/2);
  const G4ThreeVector dguard_inner_size(1100.*CLHEP::mm/2, 1100.*CLHEP::mm/2, 100.*CLHEP::mm/2);
  const G4ThreeVector dguard_outer_size(1600.*CLHEP::mm/2, 2200.*CLHEP::mm/2, 100.*CLHEP::mm/2);
  // position
  ...
  const G4ThreeVector uguard_pos(field_pos.x(), field_pos.y(),
                                 field_pos.z() - (820. - 50.)*CLHEP::mm);
  const G4ThreeVector dguard_pos(field_pos.x(), field_pos.y(),
                                 field_pos.z() + (820. - 50.)*CLHEP::mm);
  const G4ThreeVector coil1_pos =
    { field_pos.x(),
      field_size.y() + yoke_ud_size.y()*2. - (coil1_size.y() + 20.*CLHEP::mm),
      field_pos.z() - field_size.z() - (coil1_size.z() + 20.*CLHEP::mm) };
  ...
  const G4ThreeVector coil5_pos =
    { field_pos.x(),
      ...
      field_pos.z() + field_size.z() + coil5_size.z() + 21.*CLHEP::mm };
  ...
  const G4ThreeVector yoke_l_pos =
    { field_pos.x() + field_size.x() + yoke_lr_size.x() + 200.*CLHEP::mm,
      0.*CLHEP::mm,
      field_pos.z() };
  ...
  // auto kurama_solid = new G4Box("KuramaSolid", 4.*CLHEP::m/2, 3.*CLHEP::m/2, 4.*CLHEP::m/2);
  ...
  //2:z
  //3:angle
  size_COIL6[0] = 50.0*CLHEP::mm;
  size_COIL6[1] = coil1_size.y()*2+size_COIL6[0];
  //  size_COIL6[1] = 330.*CLHEP::mm;
  size_COIL6[2] = 280.*CLHEP::mm/2;
  size_COIL6[3] = 90.*CLHEP::deg;
  ...
  pos_COIL6LU[ThreeVector::Z] = field_pos.z() - field_size.z()-(size_COIL6[ThreeVector::Z]+21.*CLHEP::mm);
  //RU
  ...
  pos_COIL6RU[ThreeVector::Z] = field_pos.z() - field_size.z()-(size_COIL6[ThreeVector::Z]+21.*CLHEP::mm);
  //LD
  ...
  pos_COIL6LD[ThreeVector::Z] = field_pos.z()  - field_size.z()-(size_COIL6[ThreeVector::Z]+21.*CLHEP::mm);
  //RD
  ...
  pos_COIL6RD[ThreeVector::Z] = field_pos.z()  - field_size.z()-(size_COIL6[ThreeVector::Z]+21.*CLHEP::mm);
  ...
  rotcoil6lu->rotateZ(0.*CLHEP::deg);
  new G4PVPlacement(rotcoil6lu,
                    ...
                    false,
                    0);
  rotcoil6ru->rotateZ(-90.*CLHEP::deg);
  new G4PVPlacement(rotcoil6ru,
                    ...
                    false,
                    0);
  rotcoil6ld->rotateZ(-180.*CLHEP::deg);
  new G4PVPlacement(rotcoil6ld,
                    ...
                    false,
                    0);
  rotcoil6rd->rotateZ(-270.*CLHEP::deg);
  new G4PVPlacement(rotcoil6rd,
                    ...
                    false,
                    0);
  //  m_rotation_matrix->rotateZ(90.*CLHEP::deg);
  //  m_rotation_matrix->rotateZ(90.*CLHEP::deg);
  ...
  //2:z
  //3:angle
  size_COIL8[0] = 50.0*CLHEP::mm;
  size_COIL8[1] = coil5_size.y()*2.+size_COIL8[0];
  size_COIL8[2] = 280.*CLHEP::mm/2;
  size_COIL8[3] = 90.*CLHEP::deg;
  ...
  pos_COIL8LU[ThreeVector::Z] = field_pos.z() + field_size.z()+(size_COIL8[ThreeVector::Z]+21.*CLHEP::mm);
  //RU
  ...
  pos_COIL8RU[ThreeVector::Z] = field_pos.z() + field_size.z()+(size_COIL8[ThreeVector::Z]+21.*CLHEP::mm);
  //LD
  ...
  pos_COIL8LD[ThreeVector::Z] = field_pos.z()  + field_size.z()+(size_COIL8[ThreeVector::Z]+21.*CLHEP::mm);
  //RD
  ...
  pos_COIL8RD[ThreeVector::Z] = field_pos.z()  + field_size.z()+(size_COIL8[ThreeVector::Z]+21.*CLHEP::mm);
  ...
  rotcoil8lu->rotateZ(0.*CLHEP::deg);
  new G4PVPlacement(rotcoil8lu,
                    ...
                    false,
                    0);
  rotcoil8ru->rotateZ(-90.*CLHEP::deg);
  new G4PVPlacement(rotcoil8ru,
                    ...
                    false,
                    0);
  rotcoil8ld->rotateZ(-180.*CLHEP::deg);
  new G4PVPlacement(rotcoil8ld,
                    ...
                    false,
                    0);
  rotcoil8rd->rotateZ(-270.*CLHEP::deg);
  ...
  rotcoil7ulu->rotateZ(0.*CLHEP::deg);
  rotcoil7ulu->rotateX(180.*CLHEP::deg);
  rotcoil7ulu->rotateY(90.*CLHEP::deg);
  new G4PVPlacement(rotcoil7ulu,
                    ...
                    false,
                    0);
  rotcoil7uru->rotateZ(0.*CLHEP::deg);
  rotcoil7uru->rotateX(180.*CLHEP::deg);
  rotcoil7uru->rotateY(90.*CLHEP::deg);
  new G4PVPlacement(rotcoil7uru,
                    ...
                    false,
                    0);
  rotcoil7urd->rotateZ(0.*CLHEP::deg);
  rotcoil7urd->rotateX(90.*CLHEP::deg);
  rotcoil7urd->rotateY(90.*CLHEP::deg);
  new G4PVPlacement(rotcoil7urd,
                    ...
                    false,
                    0);
  rotcoil7uld->rotateZ(0.*CLHEP::deg);
  rotcoil7uld->rotateX(90.*CLHEP::deg);
  rotcoil7uld->rotateY(90.*CLHEP::deg);
  new G4PVPlacement(rotcoil7uld,
                    ...
                    false,
                    0);
  rotcoil7dlu->rotateZ(0.*CLHEP::deg);
  rotcoil7dlu->rotateX(-90.*CLHEP::deg);
  rotcoil7dlu->rotateY(90.*CLHEP::deg);
  new G4PVPlacement(rotcoil7dlu,
                    ...
                    false,
                    0);
  rotcoil7dru->rotateZ(0.*CLHEP::deg);
  rotcoil7dru->rotateX(-90.*CLHEP::deg);
  rotcoil7dru->rotateY(90.*CLHEP::deg);
  new G4PVPlacement(rotcoil7dru,
                    ...
                    false,
                    0);
  rotcoil7drd->rotateZ(0.*CLHEP::deg);
  rotcoil7drd->rotateX(0.*CLHEP::deg);
  rotcoil7drd->rotateY(90.*CLHEP::deg);
  new G4PVPlacement(rotcoil7drd,
                    ...
                    false,
                    0);
  rotcoil7dld->rotateZ(0.*CLHEP::deg);
  rotcoil7dld->rotateX(0.*CLHEP::deg);
  rotcoil7dld->rotateY(90.*CLHEP::deg);
  ...
  // Virtual Plane
  auto vp_solid = new G4Box("VPSolid", 2.*CLHEP::m/2, 2.*CLHEP::m/2, 0.001*CLHEP::mm/2);
...
DetectorConstruction::ConstructLAC()
{
  ...
  const auto& ra2 = gGeom.GetRotAngle2("LAC") * CLHEP::deg;
  const auto& frame_size = gSize.GetSize("LacFrame") * 0.5 * CLHEP::mm;
  const auto& radiator_size = gSize.GetSize("LacRadiator") * 0.5 * CLHEP::mm;
  // Mother
  auto mother_solid = new G4Box("LacMotherSolid",
                                frame_size.x() + 50.*CLHEP::mm,
                                frame_size.y() + 50.*CLHEP::mm,
                                frame_size.z() + 50.*CLHEP::mm);
  auto mother_lv = new G4LogicalVolume(mother_solid,
                                       m_material_map["Air"],
                                       "LacMotherLV");
  auto rot = new G4RotationMatrix;
  ...
  pos.set(0., 0., -frame_size.z() + radiator_size.z() + 10.*CLHEP::mm);
  new G4PVPlacement(nullptr, pos, radiator_lv,
                    "LacRadiatorPV", frame_lv, false, 0);
  // Mirror
  const G4double mirror_thickness = 1.*CLHEP::mm/2.;
  const G4double mirror_space = 20.*CLHEP::mm;
  const G4ThreeVector triangle_size(710.59*CLHEP::mm, frame_size.y(), 500.*CLHEP::mm);
...
DetectorConstruction::ConstructBAC()
{
  ...
  if(ac_use==1.){
    const G4double DX_PVC1 = 10.0/2.*CLHEP::mm;
    const G4double DZ_PVC1 = (340.-DX_PVC1)*tan(22.5*CLHEP::deg)*CLHEP::mm/2;
    const G4double DY_PVC1 = 440.0*CLHEP::mm;
    // const G4double DX_PVC2 = 10.0/2.*CLHEP::mm;
    const G4double DZ_PVC2 = (340.-DX_PVC1)*tan(22.5*CLHEP::deg)*CLHEP::mm/2;
    // const G4double DY_PVC2 = 440.0*CLHEP::mm;
    G4Box* pvcSolid1= new G4Box("SIDE PVC1", DX_PVC1, DY_PVC1,  DZ_PVC1);
    // G4Box* pvcSolid2= new G4Box("SIDE PVC2", DX_PVC2,
    //                                    DY_PVC2,  DZ_PVC2);

    // 16 PVC
    const G4double dangleOut_pvc = 22.5*2*CLHEP::deg;
    G4ThreeVector posMOut1_pvc(340.*CLHEP::mm,0.*CLHEP::mm,(-DZ_PVC2)); //x,z,y??
    G4ThreeVector posMOut2_pvc(340.*CLHEP::mm,0.*CLHEP::mm,(+DZ_PVC2)); //x,z,y??
    G4RotationMatrix* rotMOutP_pvc = new G4RotationMatrix;
    rotMOutP_pvc->rotateY(dangleOut_pvc*0.5-22.5*CLHEP::deg);
    posMOut1_pvc.rotateY(dangleOut_pvc*0.5-22.5*CLHEP::deg);
    posMOut2_pvc.rotateY(dangleOut_pvc*0.5-22.5*CLHEP::deg);
    for(G4int k=0;k<8; k++){
...
DetectorConstruction::ConstructSCH()
{
  ...
  const auto& sch_size = gSize.GetSize("SchSeg") * 0.5 * CLHEP::mm;
  const G4double dXdW = gGeom.GetWirePitch("SCH") * CLHEP::mm;
...
DetectorConstruction::ConstructSDC1()
{
  ...
  const auto& frame_size = gSize.GetSize("Sdc1Frame") * 0.5 * CLHEP::mm;
  const auto& drift_size = gSize.GetSize("Sdc1Drift") * 0.5 * CLHEP::mm;
  ...
  for(G4int i=0; i<NumOfLayersSDC1; ++i){
    ...
    switch (i) {
    case 0:
      pos.setZ(-22.5985*CLHEP::mm);
      break;
    case 1:
      pos.setZ(-17.4015*CLHEP::mm);
      break;
    case 2:
      pos.setZ(-2.5985*CLHEP::mm);
      break;
    case 3:
      pos.setZ(2.5985*CLHEP::mm);
      break;
...
DetectorConstruction::ConstructSDC3()
{
  ...
  const auto& frame_size = gSize.GetSize("Sdc3Frame") * 0.5 * CLHEP::mm;
  const auto& drift_size = gSize.GetSize("Sdc3Drift") * 0.5 * CLHEP::mm;
  ...
  for(G4int i=0; i<NumOfLayersSDC3; ++i){
    ...
    switch (i) {
    case 0:
      pos.setZ(-16.0*CLHEP::mm);
      break;
    case 1:
      pos.setZ(-8.206*CLHEP::mm);
      break;
    case 2:
      pos.setZ(8.206*CLHEP::mm);
      break;
...
DetectorConstruction::ConstructSDC4()
{
  ...
  const auto& frame_size = gSize.GetSize("Sdc4Frame") * 0.5 * CLHEP::mm;
  const auto& drift_size = gSize.GetSize("Sdc4Drift") * 0.5 * CLHEP::mm;
  ...
  for(G4int i=0; i<NumOfLayersSDC4; ++i){
    ...
    switch (i) {
    case 0:
      pos.setZ(-34.868*CLHEP::mm);
      break;
    case 1:
      pos.setZ(-17.547*CLHEP::mm);
      break;
    case 2:
      pos.setZ(17.547*CLHEP::mm);
      break;
...
DetectorConstruction::ConstructShsMagnet()
{
#if 0 // Old version
  const auto& tpc_pos = gGeom.GetGlobalPosition("HypTPC");
  const G4double DPHI_TPC = 360.*CLHEP::deg;
  auto tube_solid = new G4Tubs("TubeSolid", 45.*CLHEP::cm, 80.*CLHEP::cm, 135./2.*CLHEP::cm, 0.*CLHEP::deg, DPHI_TPC);
  auto hole_solid = new G4Box("HoleSolid", 100./2.*CLHEP::cm, 100./2.*CLHEP::cm, 60./2.*CLHEP::cm);
  G4ThreeVector HTrans(0, -60.*CLHEP::cm, 0);
  ...
  const G4ThreeVector yoke_size(1550./2.*CLHEP::mm, 950./2.*CLHEP::mm, 1200./2.*CLHEP::mm);
  ...
  G4double yoke_width[NumOfParams] = { 1550*CLHEP::mm, 1530*CLHEP::mm, 1480*CLHEP::mm, 1470*CLHEP::mm };
  G4double yoke_depth[NumOfParams] = { 1200*CLHEP::mm, 1180*CLHEP::mm, 1140*CLHEP::mm, 1130*CLHEP::mm };
  G4double yoke_height[NumOfParams] = { 950*CLHEP::mm, 890*CLHEP::mm, 732*CLHEP::mm, 712*CLHEP::mm };
  G4double coner_size[NumOfParams] = { 1449.569*CLHEP::mm, 1429.569*CLHEP::mm,
				       1357.645*CLHEP::mm, 1347.645*CLHEP::mm };
  G4double chamber_rad[NumOfParams] = { 800./2.*CLHEP::mm, 820./2.*CLHEP::mm,
					850./2.*CLHEP::mm, 860./2.*CLHEP::mm };
  G4double hole_gap[NumOfParams] = { 300*CLHEP::mm, 320*CLHEP::mm, 348*CLHEP::mm, 358*CLHEP::mm };
  G4double side_gap[NumOfParams];
  for(G4int i=0 ; i<NumOfParams; ++i){
    side_gap[i] = yoke_depth[i]/2.0*std::sqrt(2.)*CLHEP::mm;
  }
  G4double dummy_size[3] = { 2000*CLHEP::mm, 2000*CLHEP::mm, 2000*CLHEP::mm };
  ...
  rot_magnet->rotateZ(45.*CLHEP::deg);
  for(G4int i=0; i<NumOfParams; ++i){
    ...
    tube_solid[i] = new G4Tubs(Form("Tube%dSolid", i), 0., chamber_rad[i],
                               2000*CLHEP::mm, 0.*CLHEP::deg, 360.*CLHEP::deg);
  ...
  rot_frame.rotateX(90.*CLHEP::deg);
  new G4PVPlacement(G4Transform3D(rot_frame, G4ThreeVector()),
                    magnet_lv, "ShsMagnetPV", m_world_lv, false, 0);
  // Coil Support
  G4double CoilSupPos_height = 250*CLHEP::mm;
  G4double RadIn = 445*CLHEP::mm;
  G4double RadOut= 545*CLHEP::mm;
  G4double GapRadIn = 465*CLHEP::mm;
  G4double GapRadOut = 545*CLHEP::mm;
  G4double SupHeight = 112*CLHEP::mm;
  G4double GapHeight = 62*CLHEP::mm;
  ...
  auto solidTube_Sub = new G4Tubs("CoilSupSubSolid", GapRadIn, GapRadOut+20*CLHEP::mm,
                                  GapHeight/2., 0*CLHEP::deg, 360*CLHEP::deg);
  ...
  // Coil
  const G4double coilRad_in = 466*CLHEP::mm;
  const G4double coilRad_out = 535*CLHEP::mm;
  const G4double coilHeight = 60*CLHEP::mm;
  const G4ThreeVector coilu_pos(0*CLHEP::mm, 250*CLHEP::mm, 0*CLHEP::mm);
  const G4ThreeVector coild_pos(0*CLHEP::mm, -250*CLHEP::mm, 0*CLHEP::mm);
  auto solidDetectorCoil = new G4Tubs("CoilSolid", coilRad_in, coilRad_out,
                                      coilHeight/2., 0*CLHEP::deg, 360*CLHEP::deg);
...
{
  const auto& ra2 = gGeom.GetRotAngle2("WC") * CLHEP::deg;
  const auto& half_size_In = gSize.GetSize("WcSegIn") * 0.5 * CLHEP::mm;
  const auto& half_size_Out = gSize.GetSize("WcSegOut") * 0.5 * CLHEP::mm;
  ...
  auto mother_solid = new G4Box("WcMotherSolid",
                                half_size_Out.x()*NumOfSegWC + 200.*CLHEP::mm,
                                half_size_Out.y() + 200.*CLHEP::mm,
                                half_size_Out.z()*2 + 200.*CLHEP::mm);
  // half_size_Out.x()*NumOfSegWC + 50.*CLHEP::mm,
  // half_size_Out.y() + 50.*CLHEP::mm,
  // half_size_Out.z()*2 + 50.*CLHEP::mm);
  ...
  //Temporary!!!!!!
  //WC frame (test)
  //double Alcut_z =0.*CLHEP::mm;
  double Alcut_z =(1000.-(250.+403.))*CLHEP::mm;

  auto Alframe1     = new G4Box("Alframe1",
  80.*CLHEP::mm/2.,
  80.*CLHEP::mm/2.,
  2000.*CLHEP::mm/2. - Alcut_z/2.);
  ...
  auto pos_frame1_1 = G4ThreeVector(-pitch/2.-3000.*CLHEP::mm/2.,
  -2000.*CLHEP::mm,
  -1.*Alcut_z/2.);

  auto pos_frame1_2 = G4ThreeVector(-pitch/2.+3000.*CLHEP::mm/2.,
  -2000.*CLHEP::mm,
  -1.*Alcut_z/2.);
  ...
  auto pos_frame2_1 = G4ThreeVector(-pitch/2.-3000.*CLHEP::mm/2.,
  -1000.*CLHEP::mm,
  750/2.);

  auto pos_frame2_2 = G4ThreeVector(-pitch/2.+3000.*CLHEP::mm/2.,
  -1000.*CLHEP::mm,
  750/2.);
